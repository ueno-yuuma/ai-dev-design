...
class Model_Auth extends \Model
{
     ...
     * 
     * @param string $google_user_id User's Google ID
     * @param string $chart_id Chart ID
     * @return bool True if user has access, false otherwise
     */
    public static function user_can_access_chart($google_user_id, $chart_id)
    {
        try {
            ...
            return $chart->google_user_id === $google_user_id;
